...
| `/pr draft`, `/pr ready` | `/agent-skills:git-workflow-and-versioning` | Follow the draft and ready PR lifecycle |
| `/verify` | `/agent-skills:verification-and-validation` | Verify the assembled feature against acceptance criteria |
| `/constraints` | `/agent-skills:constraint-driven-development` | Establish the quality bar |
