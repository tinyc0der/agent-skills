...
- Optional `role`, `parent`, and `children` on track specs and bug reports record Epic parent/child links. They are structural, not maturity, progress, or verification. Omit them on historical and standalone tracks.
