...
- `decisions/` records individual contextual choices as they arise: the problem, choice, alternatives, rationale, and consequences. Current architecture and technology overviews may cite these records while the records retain decision history.
