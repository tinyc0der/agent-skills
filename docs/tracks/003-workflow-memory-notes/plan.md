...
Task status lives in [todo.md](todo.md); working context lives in [memory-delta.md](memory-delta.md). The change is reversible through Git and introduces no new command or service.
