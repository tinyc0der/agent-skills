...
| [delegate](skills/delegate/SKILL.md) | Delegates bounded tasks once to fresh Orca sessions; coordinates phases when requested | One-shot delegation or supervised planning, implementation, independent verification, and review across runners |
