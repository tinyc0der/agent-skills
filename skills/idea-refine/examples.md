...
## Open Questions
- How should a changed menu affect a saved order? Blocks the reorder flow design.
...
- Which pricing model should the pilot test? Needed before recruiting paying restaurants.
