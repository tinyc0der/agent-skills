...
> **Scope:** This file configures agents working on the [`tinyc0der/agent-skills`](https://github.com/tinyc0der/agent-skills) repository itself. It is not meant to be copied into other projects or into a global agent configuration; the reusable assets are the skills in `skills/`, not this file.
